...
1.0.0.1 (02.15.2017)
    ...
    "AssessmentObjectiveID" > "Assessment Objective ID"
#>
    ...
    PROCESS {
        ...
        if (!($docColumns -contains "Allocated Assessment ID" -and $docColumns -contains "Allocated Control ID" -and $docColumns -contains "Assessed By" -and $docColumns -contains "Assessment Date" -and $docColumns -contains "Assessment Objectives" -and $docColumns -contains "Assessment Status" -and $docColumns -contains "Assessment Objective ID" -and $docColumns -contains "Authorization Package" -and $docColumns -contains "Comments" -and $docColumns -contains "Control Implementation Status" -and $docColumns -contains "Control Name" -and $docColumns -contains "Control Number" -and $docColumns -contains "Impact Code" -and $docColumns -contains "Implementation Details" -and $docColumns -contains "Methods Used")) {
